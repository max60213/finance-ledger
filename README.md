...
以下表格是模擬數字，用來示範這個 skill 會輸出什麼樣的月報格式，實際金額會依照使用者每天輸入的花費自動更新。

### 模擬與實際差異表

| 類別 | 模擬金額 | 實際金額 | 結餘 | 使用率 | 判讀 |
| --- | ---: | ---: | ---: | ---: | --- |
| 飲食 | 12,000 | 2,145 | +9,855 | 17.9% | 達標或有結餘 |
| 訂閱費 | 1,249 | 1,249 | +0 | 100.0% | 達標或有結餘 |
| 交通 | 400 | 189 | +211 | 47.3% | 達標或有結餘 |
| 投資 | 13,000 | 13,000 | +0 | 100.0% | 達標或有結餘 |
| 儲蓄 | 10,000 | 0 | +10,000 | 0.0% | 尚未投入 |
| 其他 | 5,255 | 540 | +4,715 | 10.3% | 達標或有結餘 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 06-01 | 620 | 126 | 0 | -220 | -220 |
| 06-02 | 310 | 0 | 0 | +90 | -130 |
| 06-03 | 425 | 0 | 0 | -25 | -155 |
| 06-04 | 280 | 63 | 0 | +120 | -35 |
| 06-05 | 510 | 0 | 30 | -110 | -145 |

這些數字也是模擬值，只是用來展示表格與欄位格式，並不代表任何真實支出。
